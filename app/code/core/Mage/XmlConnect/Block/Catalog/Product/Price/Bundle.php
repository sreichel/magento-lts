        ...
        if ($product->getPriceView()) {
            if ($taxHelper->displayBothPrices()) {
                $priceXmlObj->addAttribute(
                    ...
                    $coreHelper::currency($minimalPriceTax, true, false)
                );
                ...
                $priceXmlObj->addAttribute(
                    ...
                    $coreHelper::currency($minimalPriceInclTax, true, false)
                );
            } else {
                $priceXmlObj->addAttribute(
                    'as_low_as',
         ...
         */
            ...
            if ($minimalPrice <> $maximalPrice) {
                ...
                if ($taxHelper->displayBothPrices()) {
                    $priceXmlObj->addAttribute(
                        'to_excluding_tax',
                        $coreHelper::currency($maximalPriceTax, true, false)
                    );
                    if ($weeeTaxAmount && $product->getPriceType() == 1
                        && $weeeHelper->typeOfDisplay($product, array(2, 1, 4))
                    ) {
                    ...
                    $priceXmlObj->addAttribute(
                        'to_including_tax',
                        $coreHelper::currency($maximalPriceInclTax, true, false)
                    );
                } else {
